...
call s:HL('Normal', 'Palette15', 'Palette0')

call s:HL('Folded', 'Grey50', 'Palette0', 'none')
...
call s:HL('Repeat',      'DarkOrange4', '', 'none')
"
...
call s:HL('Constant',  'Palette9', '', 'bold')
